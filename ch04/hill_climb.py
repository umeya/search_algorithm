...
class HillClimb():
    ...
    def play_game(self, numbers:int=10) -> None:
        ...
        print(f'  ------------ initial state (total numbers in maze = {s})')
        ...
        print()
        print(f'Score of hill climb action: {best_score_}')
    ...
    def set_const(self):
        ...
        try:
            ...
            print(
                './hill_climb_py MAZE_WIDTH=4 --MAZE_HEIGHT=3 --GAME_END_TURN=4 --PRINT_STATE=y')
            sys.exit(0)
